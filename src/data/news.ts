...
export function articleSeo(article: Article): ResolvedSeo {
  ...
  return resolveSeo(article.seo, {
    title: `${article.title} — Berita HMTL UNTAN`,
...
export const articles: Article[] = [
  {
    id: "news-1",
    title: "HMTL UNTAN Tanam 1000 Pohon di Kawasan Mangrove Mempawah",
    ...
    content: `<p>Pontianak — Himpunan Mahasiswa Teknik Lingkungan Universitas Tanjungpura (HMTL UNTAN) berhasil melaksanakan kegiatan penanaman 1000 pohon mangrove di kawasan pesisir Mempawah, Kalimantan Barat.</p>
...
<p>"Sebagai mahasiswa Teknik Lingkungan, sudah menjadi tanggung jawab kami untuk terlibat langsung dalam upaya pelestarian lingkungan," ujar Ketua Pelaksana.</p>`,
    ...
    image_alt: "Mahasiswa HMTL menanam mangrove",
  ...
  },
  {
    ...
    excerpt:
      "HMTL UNTAN menyelenggarakan seminar nasional dengan pembicara dari Kementerian LHK dan akademisi terkemuka.",
    content: `<p>Departemen Pendidikan HMTL UNTAN sukses menyelenggarakan Seminar Nasional bertema "Inovasi Teknologi Pengolahan Air Limbah untuk Pembangunan Berkelanjutan".</p>
<p>Acara ini menghadirkan pembicara dari Kementerian Lingkungan Hidup dan Kehutanan serta professor dari ITB dan UI. Lebih dari 300 peserta dari berbagai universitas di Indonesia turut berpartisipasi secara hybrid.</p>`,
    ...
    author: "Tim Kominfo",
    image: "/placeholder-news.png",
    image_alt: "Seminar Nasional HMTL UNTAN",
  ...
  },
  {
    ...
    content: `<p>Departemen Kewirausahaan HMTL UNTAN membuka pre-order Hoodie Green Engineering Batch 2. Hoodie ini hadir dengan desain baru yang lebih fresh namun tetap mempertahankan identitas Teknik Lingkungan.</p>
...
<p>Pre-order dibuka hingga 10 Agustus 2026 atau sampai kuota 40 pcs terpenuhi.</p>`,
  ...
  {
    id: "news-4",
    title: "HMTL UNTAN Raih Juara 1 Kompetisi Paper Lingkungan Se-Kalimantan",
    slug: "juara-1-kompetisi-paper-lingkungan",
    excerpt:
      "Delegasi HMTL UNTAN berhasil meraih juara pertama dalam kompetisi paper ilmiah tingkat regional.",
    content: `<p>Tim delegasi dari HMTL UNTAN berhasil membawa pulang trophy juara 1 dalam Kompetisi Paper Ilmiah Lingkungan Se-Kalimantan yang diselenggarakan di Universitas Lambung Mangkurat, Banjarmasin.</p>
<p>Paper berjudul "Optimasi Fitoremediasi Menggunakan Tanaman Lokal untuk Pengolahan Grey Water Permukiman" berhasil meyakinkan dewan juri.</p>`,
    ...
    author: "Tim Kominfo",
    image: "/placeholder-news.png",
    image_alt: "Tim HMTL dengan trophy juara",
